...
{
    public partial class frmSearchDialog_ProductInventory : SearchTextEdit.frmDialogDataSearchBase
    {
        Business.bllData_ProductInventory bll;
        public frmSearchDialog_ProductInventory()
        {
            InitializeComponent();
            bll = new Business.bllData_ProductInventory();
        }
