...
using GZFrameworkDemo.Business.Dictionary;

namespace GZFrameworkDemo.Dictionary
{
    public partial class frmUser : frmBaseDataBusiness
    {
        bllUser bll;
        public frmUser()
        {
        ...
        private void frm_Load(object sender, EventArgs e)
        {
            ...
            base.AddControlsOnlyRead(this.txtIsSysLock, this.txtCreateUser, this.txtCreateDate, this.txtLastUpdateUser, this.txtLastUpdateDate);
        }
        //查询
        private void btn_Search_Click(object sender, EventArgs e)
        {
            ...
            if (!String.IsNullOrEmpty(txts_Account.Text)) dic.Add("@Account", txts_Account.Text);
            if (!String.IsNullOrEmpty(txts_UserName.Text)) dic.Add("@UserName", txts_UserName.Text);
